 ...
 * MyBatis-Plus 代码生成类
 */
public class LearningCenterCodeGenerator {

    // TODO 修改服务名以及数据表名
    private static final String SERVICE_NAME = "learning_center";
    ...
    private static final String[] TABLE_NAMES = new String[]{
            "ilearn_choose_course",
            "ilearn_course_tables",
            "ilearn_learn_record",
    };
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/ilearn_" + SERVICE_NAME
