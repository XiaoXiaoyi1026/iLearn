...
public class GatewayAuthFilter implements GlobalFilter, Ordered {
     ...
     * 获取token
     */
    private @Nullable String getToken(@NotNull ServerWebExchange exchange) {
    ...
    private @NotNull Mono<Void> buildReturnMono(String error, @NotNull ServerWebExchange exchange) {
