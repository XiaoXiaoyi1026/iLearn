 ...
 */
@FeignClient(name = "iLearn-media-api", configuration = {MultipartSupportConfig.class}, url = "localhost:63050", path = "/media", fallbackFactory = MediaServiceClientFallbackFactory.class)
