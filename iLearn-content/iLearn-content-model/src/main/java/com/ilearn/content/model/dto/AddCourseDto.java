 ...
 * @author xiaoxiaoyi
 * @version 1.0
 * @description 前端添加课程dto
 * @date 2023/01/27 16:50
 */
@Data
@ApiModel(value = "新增课程Dto", description = "新增课程基本信息")
public class AddCourseDto {
    ...
    @NotEmpty(message = "课程一级分类不能为空", groups = {ValidationGroups.Insert.class, ValidationGroups.Update.class})
    @ApiModelProperty(value = "大分类", required = true)
    private String mt;

    @NotEmpty(message = "课程二级分类不能为空", groups = {ValidationGroups.Insert.class, ValidationGroups.Update.class})
