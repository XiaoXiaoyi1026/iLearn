...
public class StringUtil {
     ...
     * @return 是否被包装
     */
    public static boolean isWrap(@NotNull String str, String prefix, String suffix) {
     ...
     * @return 是否被包装
     */
    public static boolean isWrap(@NotNull String str, char prefixChar, char suffixChar) {
     ...
     * @return 补充后的字符串
     */
    public static @NotNull String padPre(@NotNull String str, int minLength, char padChar) {
     ...
     * @return 补充后的字符串
     */
    public static @NotNull String padEnd(@NotNull String str, int minLength, char padChar) {
        if (str.length() >= minLength) {
            return str;
        }
        StringBuilder sb = new StringBuilder(minLength);
    ...
    public static @NotNull StringBuilder builder() {
    ...
    public static @NotNull StringBuilder builder(int capacity) {
     ...
     * @return StringBuilder对象
     */
    public static @NotNull StringBuilder builder(String @NotNull ... strs) {
     ...
     * @return int型数组
     */
    public static Integer @NotNull [] stringToIntegerArray(String @NotNull [] str) {
     ...
     * @return Long型数组
     */
    public static Long @NotNull [] stringTOLongArray(String @NotNull [] str) {
     ...
     * @return 如果文件后缀 jpg
     */
    public static @NotNull String getFileExt(@NotNull String src) {
     ...
     */
    public static @NotNull String getFileName(@NotNull String src) {
